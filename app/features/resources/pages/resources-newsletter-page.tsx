  ...
  return (
    <div className="bg-background text-foreground">
      <ResourceHero
        ...
        title="매주 수요일, 콘텐츠 수익화를 위한 전략과 템플릿을 보내드려요"
        description="든든AI 뉴스레터는 시니어, 부업인, 브랜드 팀이 실제로 성과를 만든 운영 전략과 템플릿, 오프라인 이벤트 소식을 전해 드립니다."
        ...
        showPlaceholder
        placeholderWrapperClass="w-full max-w-3xl rounded-3xl border border-dashed border-muted/40 bg-linear-to-br from-muted/25 via-background to-muted/40 p-1"
        placeholderCaption="※ 뉴스레터 미리보기 이미지나 구독자 후기 사진을 위한 공간입니다."
      />
        ...
        <div className="grid gap-10 md:grid-cols-[0.6fr_0.4fr] md:items-start">
          <div className="space-y-6">
            <ResourceSectionHeader
              title="뉴스레터에서 받아보실 수 있는 것"
              description="든든AI 팀이 매주 큐레이션하는 정보와 실전 자료를 정리해 드립니다."
              align="left"
              className="max-w-xl"
            />
      ...
      <section className="border-y bg-muted/10">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
          <ResourceSectionHeader
            title="주간 발행 스케줄"
            description="한 주의 흐름에 맞춰 전략, 실행, 피드백을 단계적으로 제공해 드립니다."
            align="center"
            className="max-w-4xl"
          />
      ...
      <section className="mx-auto max-w-5xl px-6 py-16 md:py-20">
        <ResourceCallout
          title="구독만으로도 든든AI의 운영 자료를 매주 받아보세요"
          description="뉴스레터 구독자에게만 제공되는 리소스 모음과 이벤트 소식을 놓치지 마세요. 구독은 언제든지 버튼 한 번으로 취소할 수 있습니다."
          containerClassName="border-primary/30 bg-primary/10 p-10 text-center shadow-lg backdrop-blur"
          extraContent={
            submitted ? (
              <div className="rounded-xl border border-primary/40 bg-primary/15 p-6 text-left">
                <Typography
                  variant="h4"
                  className="text-lg font-semibold text-primary"
                >
